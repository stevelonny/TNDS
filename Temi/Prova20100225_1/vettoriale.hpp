...
class CalorimetroIdeale : public FunzioneVettorialeBase {
    public:
        CalorimetroIdeale();
        virtual ~CalorimetroIdeale();
        
        virtual vector<double> Eval(vector<double> &stat, double t) override;

        const double getT_10(){return T_10;}
...
class CalorimetroReale : public CalorimetroIdeale {
    public:
        CalorimetroReale();
        virtual ~CalorimetroReale();
